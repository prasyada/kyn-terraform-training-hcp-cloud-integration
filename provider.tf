...
terraform {
  ...
  backend "azurerm" {
    resource_group_name   = "prashant-storage-account" #replace it with the rg of storage account
    storage_account_name  = "terraformstateprasayda" #replace it with storage account name
